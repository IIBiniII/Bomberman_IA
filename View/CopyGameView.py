...
from Model.CopyGame import CopyGame
from Model.CopyPlayer import CopyPlayer

import Model.Element as Elem

class GameViewCopy(): #Classe pour une Partie
    ...
    def __init__(self):
        ...
        self.game : CopyGame = CopyGame() #Permettera de changer la partie affiché
